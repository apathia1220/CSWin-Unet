...
class CSWinTransformerSys(nn.Module):
    ...
    def forward(self, x):
        ...
        # x, d4, d3, d2, d1 = self.forward_up_feature(x, x_downsample)
        x = self.forward_up_feature(x, x_downsample)
        # print('x:', x.shape, 'side_4:', d4.shape, 'side_3:', d3.shape, 'side_2:', d2.shape, 'side_1:', d1.shape)
        # side_4 = self.upscore5(d4)
        ...
        x = self.up_x4(x)
        x = self.output(x)
        # print('x:', x.shape, 'side_4:', side_4.shape, 'side_3:', side_3.shape, 'side_3:', side_3.shape, 'side_1:', side_1.shape)
